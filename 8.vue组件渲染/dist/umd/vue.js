(function (global, factory) {
  ...
  methods.forEach(function (method) {
    arrayMethods[method] = function () {
      ...
      ob.dep.notify(); // 如果用户调用了 push等方法 我会通知当前这个dep去更新
  ...
  var Observer = /*#__PURE__*/function () {
    function Observer(value) {
      ...
      if (Array.isArray(value)) {
        ...
        this.observerArray(value); //  这里虽然递归了 但是没有依赖收集，什么时候收集依赖呢？是在defineProperty的get中收集
      } else {
        // 对数组监控
  ...
  function initMixin(Vue) {
    ...
    Vue.prototype.$mount = function (el) {
      var vm = this;
      var options = vm.$options; // 获取el对应真是dom
      ...
      */
      Vue[type] = function (id, definition) {
        if (type === 'component') {
          ...
          definition = Vue.extend(definition); //或this.options._base.extend();
  ...
  function initExtend(Vue) {
    ...
    Vue.extend = function (extendOptions) {
      ...
      Sub.cid = cid++; // 实现Sub类继承Vue类，Sub -> Sub.prototype -> Vue.prototype

      Sub.prototype = Object.create(this.prototype);
      Sub.prototype.constructor = Sub; // 继承父类的各种方法

      Sub.options = mergeOptions$1(this.options, // 父类的options
  ...
  function initGlobalAPI(Vue) {
    ...
    initExtend(Vue); // 将用户传入Vue.component()的参数作为键值对放入Vue.options.components中
